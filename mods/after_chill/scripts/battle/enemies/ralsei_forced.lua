...
function ralsei_forced:startSequence()
    Game.battle:startCutscene(function(cutscene)
        ...
        rtext("* N-No...", 255)
        rtext("* This can't be how\nit all ends..!", 158)
        rtext("* I have to...[wait:3]\nkeep trying!", 213)
        rtext("* I won't let myself...[wait:3] succumb!", 80) 
    ...
    table.insert(me_spr, spr)
        ...
        cutscene:wait(0.7)
        cutscene:text("* (I-it...[wait:2] looks like some sort of [color:yellow]curse[color:reset]?)", "surprise_confused", "ralsei")
        ...
        noelle.chara:setWeapon("freezering")
        noelle:heal(200)
        noelle:healEffect()
        cutscene:wait(1)
