...
kris:setFacing("left")
    ...
    ralsei = function(cutscene)
        ...
        cutscene:text("* Im so sorry for initating a battle,[wait:5] please forgive me.", "down")
        cutscene:text("* Regardless we need to seal this fountain.[wait:10] I feel like the darkness is overtaking light.", "roaring")
        cutscene:text("* This might be,[wait:10] our final adventure", "roaring")
        cutscene:text("* So lets make it count!", "small_smile")
        Game:addPartyMember("ralsei")
        local follower = Game.world:spawnFollower("ralsei",  {x = ralsei.x, y = ralsei.y, party = "ralsei"})
        ralsei:remove()
        follower:setFacing("left")
