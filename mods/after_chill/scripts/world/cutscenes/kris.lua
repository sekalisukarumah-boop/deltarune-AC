...
kris:setFacing("left")
    ...
    Game.world.timer:tween(0.25, fx, {amount = 0}, "linear", function() per:removeFX("fx") end)
        ...
        cutscene:wait(0.5)
        cutscene:text("* Kris,[wait:3] why don't we think about what Susie is doing?", "small_smile_side_b")
        ...
        cutscene:text("* You're just joking,[wait:5] right?", "stressed")
        cutscene:wait(0.25)
        cutscene:text("* Of course,[wait:2] you'd never attack me!", "pleased")
        cutscene:text("* Kris...[wait:5] you're f-funny...", "stressed")
        cutscene:wait(0.2) 
        kris:setAnimation("battle/attack_ready")
        ralsei:setSprite("what")
        cutscene:wait(0.2)
        cutscene:text("* Kris..[wait:2] w-what are you doing?", "concern_smile")
        ...
        cutscene:text("* I[wait:2]-I knew you were just...[wait:3] joking!", "pleased")
