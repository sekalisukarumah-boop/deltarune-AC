...
kris:setFacing("left")
    ...
    Game.world.timer:tween(0.25, fx, {amount = 0}, "linear", function() per:removeFX("fx") end)
        ...
        cutscene:wait(0.5)
        cutscene:text("* Kris,[wait:3] why don't we think about what Susie might be doing?", "small_smile_side_b")
        ...
        cutscene:text("* Why would you brandish your sword on me?", "stressed")
        cutscene:wait(0.5) 
        cutscene:text("* K-Kris,[wait:2] listen to me..", "concern_smile")
        ralsei:setSprite("grim")
        ...
        cutscene:text("* I[wait:2]-I knew you meant no harm!", "pleased")
