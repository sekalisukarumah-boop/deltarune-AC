...
kris:setFacing("left")
    ...
    Game.world.timer:tween(0.25, fx, {amount = 0}, "linear", function() per:removeFX("fx") end)
        ...
        return Input.pressed("up") or Input.pressed("down") or Input.pressed("left") or Input.pressed("right")
        end)
        cutscene:closeText()
        Assets.playSound("damage")
        kris:setSprite("ouch")
        ...
        cutscene:wait(0.5)
        ralsei:resetSprite(); ralsei:setFacing("left")
        cutscene:text("* If you won't...[wait:4] change your mind, then I...!", "no_glasses_closed")
