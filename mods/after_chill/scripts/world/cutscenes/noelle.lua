return {
    ...
    fall = function(cutscene)
            ...
            cutscene:wait(0.5)
            cutscene:text("*[noskip][speed:0.7] Doesn't it want me to get stronger?", "sad_side")
            cutscene:text("*[noskip][speed:0.7] I must keep freezing enemies.[wait:2].[wait:2].", "sad_smile")
            Assets.playSound("wing")
            noelle:shake(2)
            noelle:resetSprite()
